...
public class EmailService : IEmailService
{
    ...
    public async Task<bool> SendPasswordResetEmailAsync(string email, string resetToken, string userName, CancellationToken cancellationToken = default)
    {
        ...
        var subject = "Residaptek - Şifrəni Sıfırlama";
...
<head>
    <meta charset='utf-8'>
    <title>Residaptek - Şifrə Sıfırlama</title>
    <style>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Residaptek hesabınız üçün şifrə sıfırlama tələbi aldıq. Əgər bu tələbi siz etməmisinizsə, bu e-poçtu görməməzlikdən gəlin.</p>
        ...
        <div class='footer'>
            <p>Bu e-poçt Residaptek sistemi tərəfindən avtomatik göndərilmişdir.</p>
            <p>© 2026 Residaptek. Bütün hüquqlar qorunur.</p>
        </div>
    </div>
</body>
</html>";
...
public class EmailSettings
{
    ...
    public string DisplayName { get; set; } = "Residaptek";
