...
{
    protected readonly SmartTeamDbContext _context;
    protected readonly DbSet<T> _dbSet;

    public Repository(SmartTeamDbContext context)
    {
        _context = context;
    ...
    public virtual async Task<T?> GetByIdWithIncludesAsync(Guid id, params Expression<Func<T, object>>[] includes)
    {
        ...
        // Since FindAsync doesn't work with Include, we need to use Where
